...
use App\Filament\Resources\ReporteGastoResource\Pages;
use App\Filament\Resources\ReporteGastoResource\RelationManagers;
...
class ReporteGastoResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageReporteGastos::route('/'),
        ];
    }
}
